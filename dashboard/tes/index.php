...
<body data-loaded="tes/index.php">
                    ...
                    <form method="post" action="server/form_process.php">
                        ...
                        <div class="row">
                            <div id="uploaded_images" class="col bg-secondary py-1">
                                <img src="server/uploads/1602653118.jpg" width="100px" height="100px">
                                <img src="server/uploads/1602653118.jpg" width="100px" height="100px">
                                <img src="server/uploads/1602653118.jpg" width="100px" height="100px">
                            </div>
                        </div>
        ...
        $('#fileupload').fileupload({
            ...
            dataType: 'html',
                ...
                if(data['result'] == 'FAILED'){
                    ...
                    $('#uploaded_images').append('<div class="uploaded_image"> <input type="text" value="'+data['result']+'" name="uploaded_image_name[]" id="uploaded_image_name" hidden> <img src="server/uploads/'+data['result']+'" / style="width: 100px;  height: 100px;"> <a href="#" class="img_rmv btn btn-danger"><i class="fa fa-times-circle" style="font-size:24px;color:red"></i></a> </div>');
